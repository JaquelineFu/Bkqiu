...
INSERT INTO `article` VALUES (255544,9999,'开源博客 - Akqid-blog使用篇','>转载请注明出处 http://www.Akqid025.com/article/details/255544\n\n## 前言\n\n前面一节简单的介绍了[blog的来源和页面展示](http://www.Akqid025.com/article/details/255897)。本节主要讲述一下如果运行和使用Akqid-blog以及自己开发过程中的一些故事。\n\n2017年5月19日更新\n由于zblog已经被别人使用，怕被别人请去喝茶，zblog正式改名为Akqid-blog。\n\n## 博客使用\n\n### 运行步骤\n\n1.下载[Akqid-blog源码](https://github.com/Akqid025/Akqid-blog);\n2.修改数据库连接信息；\n\n3.将Akqid-blog的sql文件导入到mysql数据库中(不支持oracle，别问我为什么)；\n\n4.直接使用maven工具 mvn package -DskipTests进行打包；\n\n5.使用命令 **java -jar target/Akqid-blog.jar** 运行项目\n\n6.访问 **http://localhost:8080** 进入主页\n\n### 后台模块\n\n **http://localhost:8080/login** 进行登陆\n\n默认账号密码 admin/admin\n\n随后随便你增删改查！！！哈哈\n\n## 技术难度评估\n\n​	说实话这个博客的技术难度较小，技术栈要求不高，稍微懂点spring及spring boot框架技术就能搞定，thymeleaf模板语言的语法也很简单易学，spring-boot也是可以很快入门。对于作者来说最难的莫过于CSS和JS了，各种插件整的头晕。说实话代码很烂很杂，别问我为什么用有勇气放出来，没有打击就没有进步，我也想有大牛带我装逼带我飞。\n\n##  开发过程\n其实当时确实比较忙，我也想写点东西的，一直也没什么时间。\n只记得那时候又一次git reset 操作让我几个小时的成果成为炮灰，从此之后大事小事都提交。\n然后就是弄前端比较久，因为太多东西不懂了，一直都再改。后端难度较低，花费的时间较少，当然存在很多`烂代码`,后续会进行重构的。\n\n## 后续规划\n\n后续的整体计划是：\n\n1.完善当前版本；\n\n2.前后端分离;\n\n3.展示和后台管理模块分离；\n\n如果可以的话前端会来一次大改造。前提是有人支援我。\n\n## 结语\n\n我也不知道该说些什么，感觉仅仅适合入门玩玩。\n如果想部署到服务器请参看[服务器环境搭建篇](http://www.Akqid025.com/article/details/252042)\n\n搜索优化对自己来说才是真正的难点，各种不懂，各种百度，google，比使用IDE发布有难度的多，更具有挑战性，可以从中学习到很多新的东西。\n\n总结一点：实践出真知。\n\n与君共勉！！！\n\n\n\n\n\n\n\n\n\n','本篇主要介绍如何运行本项目，其实和普通项目没什么区别，只是打包成了可执行得jar包。非常符合spring boot的特性。',1,'Akqid','2017-05-18 20:03:01','2017-05-19 19:27:57',1232),(255897,9999,'开源博客 -Akqid-Blog简介篇','>转载请注明博客出处 http://www.Akqid025.com/article/details/255897\n\n## 前言\n\n​	一直都准备做一个博客系统，直到四月份才真正的拉开序幕，之前自己没能调整好状态，越发的感慨要静下心好好做点东西。四月份下定决心要开始做出这个项目，此博客系统大部分都是在晚上或者周末抽空开发的，中间肯定存在着许多的不足和BUG，希望大家能踊跃的反馈给我。可以在[issues](https://github.com/Akqid025/Akqid-blog/issues)提出以及发送邮件到Akqid025@gmail.com 目前代码已经托管在github，欢迎大家star和fork，也鼓励大家进行二次开发。\n\n面临毕业有点小忙，若未能及时反馈，请见谅。\n\n作品演示站：http://www.Akqid025.com/\n\n源码地址： https://github.com/Akqid025/Akqid-blog\n\n本站鸣谢 程序员DD | 翟永超 以及 hexo主题 icarus ！！！大部分的前端博客页面都是使用的icarus主题。后台管理界面则是使用一些jquery的插件构成。\n\n2017年5月20日更新\n博客改名：\n原因是z-blog是别人已经投入运营，所以本人就老老实实的换了，意义不大。\n\n## 初衷\n\n​	在做本博客之前个人使用过CSDN，hexo等一些博客，或多或少都有一些自己的想法，一直都想做自己的博客系统，无奈自己前端学的菜，总给自己找了许多的借口去推辞，没能下定决心去尝试。\n\n​	自己学习WEB方面的技术也有很长时间了，一直都是做一些很基础的东西，没有挑战自己，更确切的说是自己太懒撒，觉得前端太麻烦而不愿意花费精力。下定决心做这个博客也是因为自己面临毕业，很多东西确实应该尝试。也是顺其自然应该进行的事情，只是取决于做一个什么样的作品。光说不练假把式这句话很精髓，道理谁都懂，只是能动手的人微乎其微。\n\n​	在编写Akqid-blog（博客系统名称）之前，自己也在担心前端的问题，本来是打算和好朋友一起做的，只是实习期大家都很忙，于是在没有办法的情况硬着头皮自己去做，其实大部分页面都是找的模板，各种模板拼凑而成的第一版博客。只是各种模板的兼容性不佳，导致期间也遇到了很多的困难，而且很多自己前端知识不懂，于是花费了很大的精力去研究。至于为什么选择editor.md作为markdown编辑器，那是因为文档齐全，有教程简单易学。我想markdown是写博客的必备技能吧。\n\n\n## 效果图\n\n首页展示部分\n\n![首页](http://of8rkrh1w.bkt.clouddn.com//2017/05/18/my-blog-home.png)\n\n文章详情页\n\n![文章详情](http://of8rkrh1w.bkt.clouddn.com//2017/05/18/my-blog-article.png)\n\n关于我\n\n![关于作者](http://of8rkrh1w.bkt.clouddn.com//2017/05/18/my-blog-aboutme.png)\n\n后端总览界面\n\n![后台管理界面](http://of8rkrh1w.bkt.clouddn.com//2017/05/18/my-blog-admin-article-list.png)\n\nmarkdown编辑器\n\n![markdown界面](http://of8rkrh1w.bkt.clouddn.com//2017/05/18/my-blog-article-markdown.png)\n\n## 技术栈\n\n### 后端\n\n- spring 服务\n- spring boot MVC\n- mybatis ORM\n- spring security 认证\n- redis（后续准备使用）\n\n### 前端\n\n- bootstrap\n- flavr（弹出层）\n- hexo主题 \n- editor.md (markdown编辑器)\n- 部分jquery插件\n- thymeleaf模板\n\n## zblog取名\n\n其实瞎取的一个，看名字都能知道是瞎搞的。哈哈！！\n\n## 结语\n\n本篇主要简单介绍一下Akqid-blog的基本情况，下一篇[开源博客-使用篇](http://www.Akqid025.com/article/details/255544)将对zblog的部署和技术进行介绍。\n\n与君共勉！！！\n\n## 源码地址\n\ngithub：[Akqid-blog源码](https://github.com/Akqid025/Akqid-blog.git)\ncsdn：[Akqid-blog源码](https://code.csdn.net/jsu_9207/Akqid-blog.git)\noschina:[Akqid-blog源码](https://git.oschina.net/Akqid025/zblog.git)\n\n\n\n\n\n\n\n','本文主要介绍自己的开源博客相关的情况和使用到的技术，希望有兴趣的朋友可以加入我一起去完善这个项目。',1,'Akqid','2017-05-18 19:57:17','2017-05-22 16:29:56',492);
...
LOCK TABLES `partner` WRITE;
/*!40000 ALTER TABLE `partner` DISABLE KEYS */;
INSERT INTO `partner` VALUES (1,'Akqid | csdn','http://blog.csdn.net/jsu_9207','Akqid的CSDN博客',1),(2,'Akqid | github','http://github.com/Akqid025','Akqid的GitHub',1);
/*!40000 ALTER TABLE `partner` ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  nickname varchar(20) default 'Akqid' null comment '昵称',
  phone char(11) null comment '电话号码',
  email varchar(50) default 'Akqid025@gmail.com' null comment '邮箱',
...
INSERT INTO `user_info` (username, avatar, nickname, phone, email, signature, address, announcement, telegram, wechart) VALUES ('admin', 'http://www.Akqid025.com/image/avatar.jpg', 'Akqid', '18574406580', 'Akqid025@gmail.com', '遇见。', '中国 - 广州', '一个随便的博客。<br>
                    很随便。<br>
                    可以随便。<br>
                    mail： alpzxy@163.com<br>
                    github: https://github.com/alpzxy <br>
                    想不到了<br>', '18676636668', 'wp');
